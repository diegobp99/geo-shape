...
footer: 'Inspired by <a href="https://worldle.teuteuf.fr" target="_blank" rel="noopener">Worldle</a> \u00b7 GeoShape \u00a9 2026',
...
aboutStory: 'GeoShape is an open-source project developed 100% using AI (OpenCode) with zero budget. It serves as a proof of concept on how AI-assisted coding can empower developers to build complete, functional, and polished applications from scratch.',
...
footer: 'Inspirado en <a href="https://worldle.teuteuf.fr" target="_blank" rel="noopener">Worldle</a> \u00b7 GeoShape \u00a9 2026',
...
hintText.textContent = getT('itWas', { name: getTranslatedName(target) });
if (gameMode === 'daily') {
isDailyPlayed = true;
...
document.addEventListener('keydown', (e) => {
if (e.key === 'Enter' && !isGameOver && !guessInput.value && document.activeElement !== guessInput) {
guessInput.focus();
}
});
currentLang = detectLanguage();
setLanguage(currentLang);
function deferredInit(){updateStatsDisplay();startGame();}
if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',deferredInit)}else{setTimeout(deferredInit,0)}